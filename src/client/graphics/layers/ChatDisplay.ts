    ...
    return html`
      <div
        class="${this._hidden
          ...
          : ""} submarine-panel p-2 pr-3 lg:p-4 relative flex flex-col-reverse overflow-y-auto h-[270px]"
        style="box-shadow: inset 0 0 18px rgba(2, 8, 20, 0.8), 0 2px 6px rgba(0, 0, 0, 0.5); pointer-events: auto; width: 260px"
      >
        <div>
          <div
